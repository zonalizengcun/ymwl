...
// Note: requires additional types generated from: <xsl:value-of select="."/></xsl:template>
  ...
  <xsl:template name="WriteGetSet">
	...
	public <xsl:value-of select="$propType"/> get<xsl:value-of select="$name"/>() { return <xsl:value-of select="$field"/>; }
	public void set<xsl:value-of select="$name"/>(<xsl:value-of select="$propType"/> value) { <xsl:value-of select="$field"/> = value; }
  ...
  <xsl:template match="FieldDescriptorProto[label='LABEL_REPEATED']">
	...
	public global::System.Collections.Generic.List&lt;<xsl:value-of select="$type" />&gt; get<xsl:call-template name="pascal"/>List() { return <xsl:value-of select="$field"/>; }
	public int get<xsl:call-template name="pascal"/>Count() { return <xsl:value-of select="$field"/>.Count; }
	public <xsl:value-of select="$type" /> get<xsl:call-template name="pascal"/>(int index) {return <xsl:value-of select="$field"/>[index]; }
  </xsl:template>
